...
def details(a):
    ...
    for z in [.94,1.02,1.10]:box('Oil sight index',(-2.975,18.411,z),(.027,.005,.002),'white',0)
    ...
    anchor('door lamp',(0,24,3.43),'Overdoor wall',(0,1,0),prop=bracket.name,members=[body.name,'Door downlight lens'])
