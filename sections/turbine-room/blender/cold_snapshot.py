...
data={'objects':objects,'materials':materials,'images':[{'name':i.name,'path':i.filepath,'packed':bool(i.packed_file),'source':i.source} for i in bpy.data.images if i.type!='RENDER_RESULT'],'cameras':scene.get('camera_contract'),'supplement':scene.get('supplementary_cameras'),'source_revision':scene.get('source_revision'),'authoring_source_sha256':scene.get('authoring_source_sha256')}
