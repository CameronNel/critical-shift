...
def door(y,n):
    ...
    text(n+' direction','ELECTRICAL / D02' if y>12 else 'REACTOR / D01',(0,y-.36,3.09),.19,align='CENTER')
...
SUPPLEMENT=[
 ('W01_entry_return',(0,4.2,1.68),(0,0,1.7),22),
 ...
 ('W06_steam_service',(8.4,8.7,1.68),(6.85,7.2,1.6),23),
]
...
def main():
    ...
    if args.phase=='full':
        ...
        from final_adjustments import apply
        apply()
