...
def check_configuration():
    ...
    if len(disk_contract) != 10 or sum(o.type=='CAMERA' and o.name.startswith('C') for o in SCENE.objects) != 10:
    ...
    ok = settings['engine'] == 'CYCLES' and settings['resolution'] == [1440, 900, 100] and settings['units'] == 'METRIC' and settings['unit_scale'] == 1 and settings['active_camera']
