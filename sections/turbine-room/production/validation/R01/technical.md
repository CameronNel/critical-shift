...
| support.SUPPORT_door lamp | FAIL | Visible prop has no verified supporting contact; Anchor contact exceeds gap, penetration, or angle tolerance |
...
| architecture.interface_markers | FAIL | Local portal and utility marker positions only; neighboring alignment is not bound |
...
| clearance.west_equipment_apron | FAIL | Evaluated triangle clipping against open clearance volume, with enclosed-volume fallback |
...
| machine.contract | FAIL | Full train requires explicit measurable shaft and symmetry contract |
