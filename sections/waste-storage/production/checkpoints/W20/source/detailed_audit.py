...
clearance=[]
for name,points,half in [('main_walk',[(0,0),(0,18)],.50),('main_carry',[(0,0),(0,18)],.90),('personnel_walk',[(0,2.4),(6.32,2.4)],.50),('booth_walk',[(-1.8,2.2),(-3.2,2.2)],.50),('residue_access',[(0,6.6),(-3.50,6.6)],.50),('shielded_access',[(0,11),(-3,11)],.50),('dry_access',[(0,6.7),(2.65,6.7)],.50),('quarantine_access',[(0,11),(3.15,11)],.50)]:
    bad=[]
...
maintenance=[]
for name,lo,hi in [('SC01_face',(-3.86,10.45,.025),(-2.96,11.35,1.9)),('SC02_face',(-3.86,11.80,.025),(-2.96,12.75,1.9)),('DR01_face',(3.175,4.925,.025),(5.325,5.825,1.9)),('DR02_face',(3.175,7.775,.025),(5.325,8.675,1.9)),('RA01_face',(-4.0,5.05,.025),(-3.1,5.95,1.9)),('RA02_face',(-4.0,6.35,.025),(-3.1,7.25,1.9)),('RA03_face',(-4.0,7.65,.025),(-3.1,8.55,1.9)),('QH01_face',(3.14,10.70,.025),(4.04,12.80,1.9)),('VF01_filters',(-5.65,14.46,.025),(-3.10,15.36,1.9)),('WB01_face',(3.70,15.47,.025),(5.40,16.37,1.9))]:
