...
cams=[o for o in s.objects if o.type=='CAMERA'];check('fixed_cameras',len(cams)==18 and all(abs(o.location.z-1.68)<.001 for o in cams),[{'name':o.name,'location':list(o.location),'lens':o.data.lens} for o in cams])
roots=[]
for o in s.objects:
