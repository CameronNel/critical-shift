...
exec(compile((Path(__file__).parent/'attachment_pass.py').read_text(),str(Path(__file__).parent/'attachment_pass.py'),'exec'))
exec(compile((Path(__file__).parent/'seam_pass.py').read_text(),str(Path(__file__).parent/'seam_pass.py'),'exec'))
exec(compile((Path(__file__).parent/'workplace_pass.py').read_text(),str(Path(__file__).parent/'workplace_pass.py'),'exec'))
exec(compile((Path(__file__).parent/'hinge_pass.py').read_text(),str(Path(__file__).parent/'hinge_pass.py'),'exec'))
exec(compile((Path(__file__).parent/'container_access_pass.py').read_text(),str(Path(__file__).parent/'container_access_pass.py'),'exec'))
exec(compile((Path(__file__).parent/'coverage_pass.py').read_text(),str(Path(__file__).parent/'coverage_pass.py'),'exec'))
exec(compile((Path(__file__).parent/'network_pass.py').read_text(),str(Path(__file__).parent/'network_pass.py'),'exec'))
exec(compile((Path(__file__).parent/'final_corrections.py').read_text(),str(Path(__file__).parent/'final_corrections.py'),'exec'))
exec(compile((Path(__file__).parent/'routing_envelope_pass.py').read_text(),str(Path(__file__).parent/'routing_envelope_pass.py'),'exec'))
exec(compile((Path(__file__).parent/'material_finish_pass.py').read_text(),str(Path(__file__).parent/'material_finish_pass.py'),'exec'))
...
out=Path(args.output) if args.output else ROOT/'blender/waste_storage_integration.blend';out.parent.mkdir(parents=True,exist_ok=True)
