...
M={
 ...
 'floor':material('Dry ground concrete','A39B8B',.86,variation=.09,bump=.003),
 ...
 'darkpaint':material('Structural blue graphite','383B3E',.75,.20,.025,0),
...
def door(name,x,y,rot=0,label='TURBINE'):
    ...
    plaque(r,label,(0,-.193,2.82),2.15,.16,size=.11)
    return r
