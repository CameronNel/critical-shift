> Historical revision C design notes. Current takeover authority is interface.json revision D, floorplan.svg, TAKEOVER_REQUIREMENTS.md and CONNECTIONS.md. This retained file is not final acceptance evidence.
