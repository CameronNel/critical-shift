...
def main():
    ...
    if not a.validate_only:
        ...
        valorant_detail.run()
        import valorant_composition
        valorant_composition.run()
        import valorant_final_details
        valorant_final_details.run()
        import valorant_balance
        valorant_balance.run()
        import valorant_readability
        valorant_readability.run()
        import valorant_surface_finish
        valorant_surface_finish.run()
        import valorant_local_balance
        valorant_local_balance.run()
        import valorant_workplace_finish
        valorant_workplace_finish.run();rev.startup()
