...
def run():
    ...
    plant=bpy.data.objects['V_LOCKER_corner_ficus'];plant.location=(2.23,6.35,.006);plant.scale=(.78,.78,1.04)
    ...
    root=k.group('V_LOCKER_draped_towel',b,(3.60,2.85,.456));life.supported(root,'LOCKER_changing_bench_01_laminate_slat.001',[(0,.005,.0055)])
    ...
    room.cam('DETAIL_FourLockers',(7.60,3.9,1.63),(3.6,3.9,1.33),21).data.sensor_width=44
