...
bpy.ops.wm.open_mainfile(filepath=str(out/'exterior-R02.blend'),load_ui=False)
bpy.context.view_layer.update();dg=bpy.context.evaluated_depsgraph_get()
ext=bpy.data.collections['EXTERIOR_spawn-room']
original=bpy.data.objects['READ_ONLY_ORIGINAL_spawn-room'].instance_collection
