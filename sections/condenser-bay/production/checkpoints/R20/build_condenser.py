...
CAMERAS = [
    ...
    # Full U04 landing: bolt ring, gasket, slab rectangle — not a tight sleeve crop.
    ("C04_EXHAUST", (1.95, 2.15, 5.02), (3.00, 4.05, 5.92), 24),
    ...
    ("C09_ROOF", (5.65, 5.55, 5.12), (3.05, 4.05, 5.88), 26),
...
WALK = [
    ...
    ("W08_GALLERY_TURN", (5.48, 4.95, 5.08), (3.35, 4.10, 4.95), 26),
]
