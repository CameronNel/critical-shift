...
def ceiling_services():
    ...
    for y in (1.5, 4.05, 7.2, 8.9):
        k.rod("tray hanger", (-0.88, y, 5.48), (-0.88, y, 6.002), 0.01, "steel")
        k.anchor("tray " + str(y), (-0.88, y, 6.002), "Ceiling slab", (0, 0, 1), 0.012, 0.006)
...
def practical_lights():
    ...
    for i, (x, y) in enumerate(
        ...
        k.rod(n + " drop L", (x, y - 0.5, 5.24), (x, y - 0.5, 6.002), 0.008, "dark")
        k.rod(n + " drop R", (x, y + 0.5, 5.24), (x, y + 0.5, 6.002), 0.008, "dark")
        k.light(n, (x, y, 5.08), (x, y, 0), 220, warm, 1.2, "RECTANGLE", 0.16)
        k.anchor(n, (x, y, 6.002), "Ceiling slab", (0, 0, 1), 0.012, 0.006)
    # Task on condenser
