...
def condensate_pumps():
    ...
    k.rod("riser hang A", (6.4, 7.6, 5.5), (6.4, 7.6, 6.002), 0.012, "steel")
    k.rod("riser hang B", (IF_CONDENSATE_HANDOFF[0], 1.4, 5.5), (IF_CONDENSATE_HANDOFF[0], 1.4, 6.002), 0.012, "steel")
    k.anchor("riser hang A", (6.4, 7.6, 6.002), "Ceiling slab", (0, 0, 1), 0.012, 0.006)
    k.anchor("riser hang B", (IF_CONDENSATE_HANDOFF[0], 1.4, 6.002), "Ceiling slab", (0, 0, 1), 0.012, 0.006)
...
def cooling_water():
    ...
    for x, y in ((8.6, 3.20), (8.6, 4.90), (5.55, 3.20), (5.55, 4.90)):
        ...
        k.rod("CW hang", (x, y, 3.28), (x, y, 6.002), 0.012, "steel")
        k.anchor("CW hang " + f"{x:.1f}_{y:.1f}", (x, y, 6.002), "Ceiling slab", (0, 0, 1), 0.012, 0.006)
...
def drainage_and_hoist():
    ...
    k.rod("hoist hang L", (5.3, 4.05, 5.48), (5.3, 4.05, 6.002), 0.014, "steel")
    k.rod("hoist hang R", (8.9, 4.05, 5.48), (8.9, 4.05, 6.002), 0.014, "steel")
    k.anchor("hoist L", (5.3, 4.05, 6.002), "Ceiling slab", (0, 0, 1), 0.012, 0.006)
    k.anchor("hoist R", (8.9, 4.05, 6.002), "Ceiling slab", (0, 0, 1), 0.012, 0.006)
