...
CAMERAS = [
    ...
    # East gallery looking through open bellows into the 2.5 x 1.5 slab hole.
    ("C04_EXHAUST", (5.42, 4.55, 5.18), (3.00, 4.05, 6.05), 26),
    # South of the pump pair: volute, cage, motor, hotwell suction.
    ("C05_RETURN", (3.15, 5.72, 1.48), (3.20, 7.55, 1.05), 24),
    ...
    ("C09_ROOF", (5.22, 3.28, 5.08), (3.00, 4.05, 6.02), 26),
    ("C10_MATERIALS", (2.50, 5.92, 1.12), (2.40, 7.05, 0.95), 32),
]
WALK = [
    ("W01_ENTRY_CORNER", (0.22, 1.70, 1.42), (0.00, -0.20, 1.15), 24),
