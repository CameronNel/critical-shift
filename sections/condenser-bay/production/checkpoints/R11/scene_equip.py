...
def cooling_water():
    ...
    for x, y in ((8.55, 2.55), (8.55, 4.05), (8.55, 5.45), (ex, ny + 0.28), (wx, 5.75)):
...
def operator_station():
    ...
    k.box("OP title plate", (X0 + 0.42, y, 2.38), (0.03, 1.55, 0.16), "dark", 0.003)
    k.text("OP title", "CSB-01  CONDENSER", (X0 + 0.40, y, 2.36), 0.09, "white", "E")
    k.text("OP subtitle", "VACUUM  /  CEP  /  CW", (X0 + 0.40, y, 2.22), 0.06, "yellow", "E")
...
def dressing():
    ...
    k.box("log clipboard", (1.15, Y1 - 0.05, 1.55), (0.36, 0.02, 0.42), "paper", 0.002)
    k.text("log title", "SHIFT LOG", (1.15, Y1 - 0.07, 1.70), 0.08, "ink", "S")
