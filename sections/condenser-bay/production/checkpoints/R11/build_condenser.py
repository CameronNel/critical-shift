...
CAMERAS = [
    ...
    # Inside the hollow chest looking up the 2.5 x 1.5 bore.
    ("C04_EXHAUST", (3.00, 3.52, 5.06), (3.00, 4.05, 6.22), 24),
    # Both CEPs, suction to hotwell, not a coupling crop.
    ("C05_RETURN", (0.22, 6.45, 1.58), (3.35, 7.70, 1.08), 24),
    ("C06_COOLING", (6.35, 2.05, 1.75), (8.75, 4.15, 3.22), 26),
    ("C07_OPERATOR", (0.92, 4.05, 1.55), (-1.20, 4.05, 1.62), 28),
    # East gallery, looking through open bellows into the slab hole.
    ("C08_MAINT", (5.52, 4.62, 5.30), (3.00, 4.05, 6.02), 28),
    ("C09_ROOF", (6.20, 2.55, 3.25), (3.00, 4.05, 5.95), 24),
    ("C10_MATERIALS", (1.12, 6.28, 1.18), (2.50, 7.05, 0.96), 32),
]
WALK = [
    ("W01_ENTRY_CORNER", (0.22, 1.62, 1.38), (0.00, -0.08, 0.72), 24),
