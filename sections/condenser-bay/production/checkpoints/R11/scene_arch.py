...
def ceiling():
    ...
    k.box("U04 reveal Y+", (EXH_C[0], EXH_C[1] + EXH_Y / 2 - 0.03, Z1 + 0.02), (EXH_X - 0.08, 0.06, 0.28), "dark", 0.004)
    k.text("U04 size X", "2.5 m", (EXH_C[0], EXH_C[1] - EXH_Y / 2 + 0.08, Z1 - 0.12), 0.10, "yellow", "S")
    k.text("U04 size Y", "1.5 m", (EXH_C[0] - EXH_X / 2 + 0.18, EXH_C[1], Z1 - 0.12), 0.10, "yellow", "E")
    ...
    k.box("U04 pit Y+", (EXH_C[0], EXH_C[1] + EXH_Y / 2 + 0.10, pit_z), (EXH_X + 0.24, 0.12, 0.90), "concrete", 0.006)
    k.box("U04 pit lid", (EXH_C[0], EXH_C[1], pit_z + 0.50), (EXH_X + 0.36, EXH_Y + 0.36, 0.08), "dark", 0.004)
    k.light("U04 pit lamp", (EXH_C[0], EXH_C[1], pit_z + 0.20), (EXH_C[0], EXH_C[1], Z1), 70, (1.0, 0.88, 0.72), 0.7, shadows=False)
