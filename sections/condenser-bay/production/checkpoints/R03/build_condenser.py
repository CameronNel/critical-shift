...
CAMERAS = [
    ("C01_ENTRY", (0.0, 0.22, 1.64), (2.6, 6.2, 2.7), 22),
    ("C02_HERO", (-1.25, 1.05, 1.72), (3.3, 4.5, 2.55), 24),
    ("C03_REVERSE", (3.05, 9.12, 1.70), (3.0, 3.5, 2.45), 22),
    ("C04_EXHAUST", (3.05, 2.42, 5.72), (3.0, 4.05, 5.92), 30),
    ("C05_RETURN", (0.28, 6.15, 1.55), (3.5, 7.7, 1.05), 28),
    ("C06_COOLING", (9.18, 1.85, 1.68), (5.1, 4.15, 2.55), 24),
    ("C07_OPERATOR", (0.62, 5.25, 1.52), (-1.12, 4.05, 1.40), 32),
    ("C08_MAINT", (5.55, 5.25, 5.72), (3.1, 4.05, 5.05), 28),
    ("C09_ROOF", (7.55, 1.25, 3.05), (3.3, 4.2, 5.45), 24),
    ("C10_MATERIALS", (1.55, 6.25, 1.18), (2.50, 7.05, 0.95), 36),
]
WALK = [
