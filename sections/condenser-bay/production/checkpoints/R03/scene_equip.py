...
def operator_station():
    ...
    for i, dy in enumerate((0.36, 0.12, -0.12, -0.36)):
        k.cyl("OP switch body", (X0 + 0.42, y + dy, 1.22), 0.028, 0.06, "steel", "X", 16)
        k.cyl("OP switch knob", (X0 + 0.48, y + dy, 1.22), 0.022, 0.05, "yellow" if i == 0 else "dark", "X", 12)
        k.pipe(
            "OP switch guard",
            [
                (X0 + 0.40, y + dy - 0.05, 1.30),
                (X0 + 0.52, y + dy - 0.05, 1.30),
                (X0 + 0.52, y + dy + 0.05, 1.30),
                (X0 + 0.40, y + dy + 0.05, 1.30),
            ],
            0.007,
    ...
    k.cyl("OP trip", (X0 + 0.46, y, 1.00), 0.035, 0.06, "red", "X", 16)
    k.pipe(
        "OP trip guard",
        [
            (X0 + 0.40, y - 0.07, 1.08),
