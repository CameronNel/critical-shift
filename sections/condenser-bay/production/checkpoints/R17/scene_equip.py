...
def condenser():
    ...
    # Bolts on the south flange face so C04 reads a landing, not nested bars.
    for x in [EXH_C[0] + d * (EXH_X / 2 + 0.10) for d in (-1, -0.6, -0.2, 0.2, 0.6, 1)]:
        k.bolt("mate bolt S", (x, y_s - 0.22, 5.99), "Y", 0.016)
