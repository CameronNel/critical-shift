...
CAMERAS = [
    ("C01_ENTRY", (-1.35, 0.48, 1.62), (3.1, 3.9, 2.15), 24),
    ("C02_HERO", (-1.45, 1.35, 1.72), (3.4, 4.6, 2.45), 22),
    ("C03_REVERSE", (3.05, 9.05, 1.70), (3.0, 4.1, 2.20), 22),
    ("C04_EXHAUST", (5.45, 4.05, 5.72), (3.05, 4.05, 5.62), 32),
    ...
    ("C08_MAINT", (5.50, 5.55, 5.72), (3.20, 4.10, 4.85), 28),
    ("C09_ROOF", (6.85, 2.25, 3.35), (3.40, 4.50, 5.35), 24),
    ("C10_MATERIALS", (1.95, 6.45, 1.18), (2.55, 7.05, 0.95), 28),
]
WALK = [
    ("W01_ENTRY_CORNER", (-1.40, 0.50, 1.60), (1.9, 2.8, 1.55), 24),
