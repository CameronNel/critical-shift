...
def gallery_repairs():
    ...
    k.pipe('EJ air suction',[(1.8,4.45,4.76),(1.8,4.45,5.96),(-.77,4.45,5.96),
                             (-.77,7.2,5.96),(-.77,7.2,1.90)],.045,'cream',.08)
    for x,y in [(1.3,4.45),(-.77,4.45),(-.77,6.8)]:
        k.box('EJ ceiling pipe clip',(x,y,5.978),(.09,.09,.044),'steel',.002)
