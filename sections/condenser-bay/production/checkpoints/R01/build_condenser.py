...
CAMERAS = [
    ("C01_ENTRY", (0.0, 0.85, 1.62), (3.0, 4.2, 2.4), 24),
    ("C02_HERO", (-0.55, 1.35, 1.68), (3.05, 4.05, 2.85), 26),
    ("C03_REVERSE", (3.15, 8.85, 1.68), (3.0, 3.4, 2.5), 24),
    ("C04_EXHAUST", (3.05, 1.75, 3.35), (3.0, 4.05, 5.55), 28),
    ("C05_RETURN", (1.15, 6.55, 1.52), (3.2, 7.6, 1.15), 30),
    ("C06_COOLING", (8.55, 4.05, 1.65), (5.15, 4.05, 2.55), 28),
    ("C07_OPERATOR", (0.95, 4.05, 1.52), (-1.15, 4.05, 1.35), 32),
    ("C08_MAINT", (5.55, 2.55, 4.55), (3.15, 4.05, 4.85), 28),
    ("C09_ROOF", (6.65, 1.45, 4.25), (3.0, 4.1, 5.45), 26),
    ("C10_MATERIALS", (1.35, 6.85, 1.28), (2.35, 7.05, 0.95), 40),
]
WALK = [
    ("W01_ENTRY_CORNER", (-1.15, 0.75, 1.60), (1.6, 2.4, 1.5), 24),
    ("W02_SW_TURN", (0.55, 1.55, 1.60), (3.0, 2.4, 1.4), 24),
    ("W03_NW", (-1.05, 8.65, 1.60), (2.2, 7.2, 1.4), 24),
    ("W04_NE", (8.85, 8.65, 1.60), (6.2, 6.4, 1.3), 24),
    ("W05_SE", (8.85, 1.55, 1.60), (6.4, 3.8, 1.5), 24),
    ("W06_WEST_AISLE", (0.15, 5.4, 1.60), (0.2, 8.4, 1.5), 22),
    ("W07_EAST_PULL", (8.2, 5.5, 1.60), (6.0, 4.05, 1.8), 24),
    ("W08_GALLERY_TURN", (5.35, 5.15, 4.72), (3.0, 4.05, 4.9), 28),
]
