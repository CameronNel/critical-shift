...
def practical_lights():
    ...
    # Task on condenser
    k.light("task CD south", (3.0, 2.35, 4.55), (3.0, 4.05, 3.2), 110, warm, 0.7, shadows=False)
    k.light("task CD east", (5.6, 4.05, 3.8), (4.6, 4.05, 3.0), 90, warm, 0.6, shadows=False)
    k.light("task pumps", (3.2, 7.5, 3.4), (3.2, 7.5, 1.0), 90, (1.0, 0.84, 0.64), 0.8, shadows=False)
    k.light("task operator", (-0.6, 4.05, 2.55), (-1.2, 4.05, 1.3), 70, (1.0, 0.78, 0.55), 0.45, shadows=False)
    k.light("entry wash", (0.0, 1.1, 2.7), (0.0, 2.5, 1.2), 90, warm, 0.9, shadows=False)
    k.light("gallery task", (5.3, 4.05, 5.35), (3.0, 4.05, 4.8), 60, warm, 0.5, shadows=False)
    k.light("neck wash", (EXH_C[0], EXH_C[1] - 0.9, 5.35), (EXH_C[0], EXH_C[1], 5.7), 80, warm, 0.45, shadows=False)
