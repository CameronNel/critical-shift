...
CAMERAS = [
    ("C01_ENTRY", (0.0, 0.14, 1.64), (2.5, 4.4, 2.25), 18),
    ("C02_HERO", (-1.45, 1.35, 1.72), (3.4, 4.6, 2.45), 22),
    ("C03_REVERSE", (3.05, 9.05, 1.70), (3.0, 4.1, 2.20), 22),
    ("C04_EXHAUST", (3.05, 1.52, 1.68), (3.05, 4.05, 5.35), 28),
    ("C05_RETURN", (2.35, 5.55, 1.35), (2.40, 7.10, 0.95), 32),
    ("C06_COOLING", (7.15, 5.85, 1.68), (8.90, 4.05, 2.85), 26),
    ("C07_OPERATOR", (0.70, 5.35, 1.52), (-1.12, 4.05, 1.38), 32),
    ("C08_MAINT", (5.75, 6.10, 5.50), (3.25, 4.15, 4.90), 28),
    ("C09_ROOF", (7.10, 6.40, 3.25), (3.40, 4.20, 5.40), 24),
    ("C10_MATERIALS", (1.95, 6.45, 1.18), (2.55, 7.05, 0.95), 28),
]
WALK = [
    ("W01_ENTRY_CORNER", (0.20, 2.45, 1.60), (0.0, 0.08, 1.50), 24),
    ("W02_SW_TURN", (0.25, 1.95, 1.60), (3.3, 2.7, 1.5), 24),
    ("W03_NW", (-1.35, 8.90, 1.60), (2.5, 6.6, 1.4), 24),
    ("W04_NE", (9.10, 8.90, 1.60), (6.0, 6.1, 1.4), 24),
    ("W05_SE", (9.10, 1.35, 1.60), (6.1, 3.5, 1.5), 24),
    ("W06_WEST_AISLE", (0.00, 5.70, 1.60), (0.15, 8.6, 1.5), 22),
    ("W07_EAST_PULL", (8.45, 5.70, 1.60), (5.6, 4.05, 2.1), 24),
    ("W08_GALLERY_TURN", (5.50, 5.35, 5.72), (3.0, 4.05, 5.00), 28),
]
...
def main():
    ...
    cameras()
    settings()
    skip_shadow = ("bolt", "tick", "grate", "stud", "saw cut", "lettering", "needle", "pivot")
    for o in S.objects:
        low = o.name.lower()
