...
def main():
    ...
    # From inside the hollow neck, below the slab, looking up through the bore.
    u04 = opening_clear((EXH_C[0], EXH_C[1], 5.55), (EXH_X * 0.72, 0, 0), (0, EXH_Y * 0.72, 0), 5, (0, 0, 1), 1.4)
    ...
    d01_ok = d01["ok"]
    u04_ok = u04["ok"]
    report['status'] = 'PASS' if d01_ok and u04_ok and not failed_sup and not teal else 'FAIL'
    report['scope'] = 'Legacy sampled door/bore and registered anchor checks only; extended audit required for route and physical support acceptance.'
