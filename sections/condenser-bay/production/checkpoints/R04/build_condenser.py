...
CAMERAS = [
    ...
    ("C04_EXHAUST", (1.35, 2.55, 5.72), (3.05, 4.05, 5.55), 28),
    ...
    ("C08_MAINT", (5.45, 3.15, 5.72), (3.15, 4.15, 4.95), 26),
    ("C09_ROOF", (7.15, 1.35, 2.85), (3.4, 4.4, 5.25), 22),
    ("C10_MATERIALS", (1.65, 6.35, 1.15), (2.45, 7.05, 0.95), 32),
]
WALK = [
