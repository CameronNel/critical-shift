...
CAMERAS = [
    ...
    ("C04_EXHAUST", (1.95, 2.12, 4.42), (3.05, 4.05, 5.78), 28),
    # 3/4 of both CEPs with hotwell behind.
    ("C05_RETURN", (0.85, 5.95, 1.52), (3.15, 6.85, 1.15), 24),
    ...
    ("C09_ROOF", (2.15, 2.25, 4.55), (3.05, 4.05, 5.85), 26),
