...
def condenser():
    ...
    k.box("CD gasket strip S", (EXH_C[0], y_s - 0.22, 5.94), (EXH_X + 0.45, 0.05, 0.06), "rubber", 0.004)
    k.box("CD flange plate S", (EXH_C[0], y_s - 0.24, 5.99), (EXH_X + 0.50, 0.06, 0.14), "struct", 0.006)
    for x in [EXH_C[0] + d * (EXH_X / 2 + 0.08) for d in (-1, -0.6, -0.2, 0.2, 0.6, 1)]:
        k.cyl("mate bolt S", (x, y_s - 0.28, 5.99), 0.022, 0.04, "steel", "Y", 8, 0.002)
