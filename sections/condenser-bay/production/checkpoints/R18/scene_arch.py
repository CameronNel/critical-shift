...
def floor():
    ...
    lg = k.text("pull bay legend", "3.5 m  BUNDLE CLEAR", (7.85, 4.35, 0.018), 0.12, "ink", "UP")
    lg.rotation_euler.z = math.pi
    k.text("pull bay legend SW", "3.5 m  BUNDLE CLEAR", (7.85, 3.75, 0.018), 0.12, "ink", "UP")
...
def stairs_and_gallery():
    ...
    k.box("stair1 stringer L", (STAIR_X0 + (STAIR_MID - STAIR_X0) / 2, STAIR_Y0 + 0.03, 1.05), (STAIR_MID - STAIR_X0 + 0.1, 0.08, 2.2), "struct", 0.004)
    k.box("stair1 stringer R", (STAIR_X0 + (STAIR_MID - STAIR_X0) / 2, STAIR_Y1 - 0.03, 1.05), (STAIR_MID - STAIR_X0 + 0.1, 0.08, 2.2), "struct", 0.004)
    # Mid landing
    ...
    k.box("stair2 stringer L", (sx - 0.44, (y0 + y1) / 2, 3.15), (0.08, y1 - y0 + 0.1, 2.3), "struct", 0.004)
    k.box("stair2 stringer R", (sx + 0.44, (y0 + y1) / 2, 3.15), (0.08, y1 - y0 + 0.1, 2.3), "struct", 0.004)
    # Railings flight 1
...
def practical_lights():
    ...
    for i, (x, y) in enumerate(
        ...
        k.light(n, (x, y, 5.08), (x, y, 0), 280, warm, 1.2, "RECTANGLE", 0.16)
    ...
    k.light("gallery task", (5.3, 4.05, 5.35), (3.0, 4.05, 4.8), 90, warm, 0.5, shadows=False)
    k.light("neck wash", (EXH_C[0], EXH_C[1] - 0.9, 5.35), (EXH_C[0], EXH_C[1], 5.7), 110, warm, 0.55, shadows=False)
    k.light("chest well", (EXH_C[0], EXH_C[1], 5.12), (EXH_C[0], EXH_C[1], 6.3), 100, warm, 0.5, shadows=False)
