...
k.M={key.value:bpy.data.materials[value.args[0].value] for key,value in zip(mapping.keys,mapping.values)}
...
manifest={'revision':rev,'baseline_sha256':expected,'blend_sha256':sha,'source_sha256':hashes,
          ...
          'method':'Documented R21 saved-baseline continuation; fixed camera transforms retained.'}
