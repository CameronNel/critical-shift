...
def route_storytelling():
    ...
    for i,(p,hd) in enumerate([((16.4,9.6),-math.pi/2),((16.4,11.8),-math.pi/2),((8.0,12.2),0),((12,14.3),math.pi/2),((12,17.6),math.pi/2),((1.2,14.6),-math.pi/2),((-1.5,20.2),math.pi/2),((-.55,21),0),((3.2,18),math.pi),((8.8,18),math.pi),((-2.6,18.6),0)]):low_guide('Route_guide_%02d'%i,p,hd)
