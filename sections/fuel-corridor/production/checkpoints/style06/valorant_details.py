...
def trolley(x=2.65,y=12.32):
    ...
    box('Cask_inventory_plate',(x+.17,y-.1555,z-.012),(.135,.002,.063),'teal',.002)
...
def wall_light(name,origin,heading=0,z=2.55,power=95):
    ...
    place_wall_group(par,origin,heading)
    c,s=math.cos(heading),math.sin(heading)
    area(name+'_pool',(origin[0]+s*.26,origin[1]-c*.26,z-.052),(origin[0]+s*.75,origin[1]-c*.75,.75),power,(1,.59,.24),.34,.16)
