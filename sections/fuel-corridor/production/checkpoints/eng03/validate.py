...
DIAGNOSTIC_CAMERAS=[
    ...
    ('D05_GATE_MECHANISM',(4.65,9.5,2.75),(6.35,10,3.5),24),
    ('D06_SERVICE_RECESS',(.70,15.2,1.72),(-1.49,15.08,1.72),32),
]
CAP_SUFFIXES = ('_sliding_leaf', '_leaf_stiffener', '_folded_return', '_kick_plate', '_leaf_panel_seam', '_leaf_gusset', '_gusset_rivet', '_localized_kick_scuff', '_leaf_carriage_hanger', '_leaf_carriage_roller', '_leaf_carriage_axle', '_leaf_identity_field', '_leaf_identity_text', '_leaf_identity_fastener', '_leaf_orange_strip', '_leaf_access_panel', '_leaf_access_fastener', '_leaf_access_type', '_leaf_pull_back', '_leaf_pull_shadow', '_leaf_pull_rail', '_leaf_pull_end', '_leaf_serial_plate', '_leaf_serial_type')
