...
def detail_dressing(stage):
    ...
    if stage=='full':
        ...
        for name,origin,angle,z in [('Entry_wall_key',(-2.2,4.8),math.pi/2,2.72),('Cross_wall_key',(9.1,12.2),0,2.72),('East_wall_key',(16.4,9.92),-math.pi/2,2.94),('Delivery_wall_key',(12,17.35),math.pi/2,2.72),('Service_corner_key',(-1.5,20.35),math.pi/2,2.65),('Medical_side_key',(8.5,21),0,2.34)]:wall_light(name,origin,angle,z,105)
        wall_vent('Entry_extract',(2.2,4.6),-math.pi/2,3.35,1.02)
        wall_vent('East_extract',(13.35,7),math.pi,3.35,1.12)
        wall_vent('Service_extract',(11.2,21),0,2.26,.72)
