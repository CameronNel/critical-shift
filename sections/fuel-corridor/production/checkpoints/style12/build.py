...
mat('glove',(.068,.079,.091),.97,variation=.06,bump=.0009)
mat('red',(.42,.075,.035),.56,.15,.05,.003)
mat('glass',(.24,.33,.31),.22,.18,0,0)
gp=M['glass'].node_tree.nodes.get('Principled BSDF');gp.inputs['Base Color'].default_value=(.62,.72,.68,1);gp.inputs['Metallic'].default_value=0;gp.inputs['Transmission Weight'].default_value=.94;gp.inputs['IOR'].default_value=1.46;gp.inputs['Roughness'].default_value=.16
