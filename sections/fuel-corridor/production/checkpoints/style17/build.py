...
rough=nn.new('ShaderNodeMapRange');rough.inputs['From Min'].default_value=.10;rough.inputs['From Max'].default_value=.36;rough.inputs['To Min'].default_value=.48;rough.inputs['To Max'].default_value=.66;ll.new(it.outputs['Color'],rough.inputs[0]);ll.new(rough.outputs[0],pb.inputs['Roughness'])
