...
CAP_SUFFIXES = ('_sliding_leaf', '_leaf_stiffener', '_folded_return', '_kick_plate', '_leaf_panel_seam', '_leaf_gusset', '_gusset_rivet', '_localized_kick_scuff', '_leaf_carriage_hanger')
