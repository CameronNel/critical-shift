...
def task_light():
    wall_light('Cask_task_light',(3.08,13.2),0,2.68,110)
...
def detail_dressing(stage):
    ...
    for i in range(4):tube('Laid_power_cable',[(-1.66+i*.07,7.48,3.921),(-1.66+i*.07,12.67,3.921)],.016,'rubber' if i%3 else 'ochre')
    if stage=='full':
