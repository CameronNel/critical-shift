...
mat('cotton',(.12,.16,.19),.98,variation=.055,bump=.0005)
M['cotton'].node_tree.nodes.get('Principled BSDF').inputs['Sheen Weight'].default_value=.30
M['glove'].node_tree.nodes.get('Principled BSDF').inputs['Sheen Weight'].default_value=.18
