...
def permit_holder(name,origin,heading=0,z=1.65):
    ...
    box(name+'_mounting_spacer',(0,.006,z),(.10,.012,.09),'steel',.001)
...
def first_aid_pack(name,origin,heading=0):
    ...
    par=local_wall_root(name,origin,heading,z,face=.012)
    box(name+'_wall_spacer',(0,.006,z),(.13,.012,.11),'steel',.001)
...
def route_storytelling():
    ...
    par=root('Clean_branch_blade_sign','ceiling',[(5.25,20.02,3),(5.25,20.78,3)],(0,0,1))
    for yy in [20.02,20.78]:
        rod('Clean_blade_drop',(5.25,yy,3),(5.25,yy,2.69),.009,'steel')
        box('Clean_blade_ceiling_foot',(5.25,yy,2.992),(.10,.10,.016),'teal',.002)
    box('Clean_blade_panel',(5.25,20.4,2.57),(.026,1.12,.24),'teal',.004)
    text_obj('Clean_blade_destination','CLEAN / MEDICAL',(5.235,20.43,2.56),.086,'ivory',(math.pi/2,0,-math.pi/2))
    mesh('Clean_blade_left_arrow',[(5.235,yy,zz) for yy,zz in [(20.83,2.525),(20.90,2.57),(20.83,2.615),(20.83,2.59),(20.77,2.59),(20.77,2.55),(20.83,2.55)]],[(0,1,2,3,4,5,6)],'ochre')
    ...
    wall_light('Reactor_turn_key',(12,15.55),math.pi/2,2.72,180)
