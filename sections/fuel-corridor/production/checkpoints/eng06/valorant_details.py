...
def route_storytelling():
    ...
    box('Clean_blade_panel',(4.95,20.25,2.57),(.026,1.12,.24),'teal',.004)
    text_obj('Clean_blade_destination','CLEAN / MEDICAL',(4.935,20.28,2.56),.086,'ivory',(math.pi/2,0,-math.pi/2))
    ...
    box('Plant_blade_panel',(0,16.0,2.46),(1.30,.026,.24),'teal',.004)
    text_obj('Plant_blade_destination','PLANT SERVICES',(.04,15.985,2.445),.090,'ivory')
