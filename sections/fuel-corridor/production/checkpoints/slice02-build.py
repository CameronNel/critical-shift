...
mat('teal',(.027,.076,.082),.59,.05,.075,.006)
mat('teal_light',(.07,.145,.145),.68,.05,.06,.005)
...
mat('ivory',(.48,.49,.43),.74,.05,.06,.005)
...
practical('Staging_warm_key',.15,11.78,4.4,290)
practical('Gate_cool_fill',3.32,8.45,4.4,135,True,math.pi/2)
if A.stage=='full':
