...
def workbench():
    ...
    for side in [-1,1]:
        ...
        box('Work_glove_palm',(gx,gy,.920),(.105,.115,.031),'glove',.018)
        for i in range(4):
            xx=gx-.037+i*.024
            beam('Glove_finger',(xx,gy+.034,.920),(xx+.003,gy+.112-(i%3)*.009,.917),.021,.024,'glove')
        beam('Glove_thumb',(gx+side*.038,gy-.022,.92),(gx+side*.078,gy+.01,.919),.024,.026,'glove')
