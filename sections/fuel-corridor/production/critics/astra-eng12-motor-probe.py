...
report={'revision':'eng12','objects':len(scene.objects),'physical_meshes':len(meshes),'hashes':hashes,
...
(HERE/'astra-eng12-motor-evidence.json').write_text(json.dumps(report,indent=2))
