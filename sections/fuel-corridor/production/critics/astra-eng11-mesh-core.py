"""Independent evaluated eng11 checks. CPU only, no render or scene save.
...
SAVED=SECTION/'production/checkpoints/eng11/Fuel_Corridor.blend'
EXPECTED='22cdfe2c2d8bf7c13070686a981118353f7d6c19dc7fbb89797102881cae7ae6'
...
assert scene.get('stage')=='full' and scene.get('revision')=='eng11'
