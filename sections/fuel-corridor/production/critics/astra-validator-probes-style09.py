...
EXPECTED_HASH = 'f18ced2168b84aa6588bae4d6e822218c508776fdbd5723dbce6ede3a1ffcdfa'
...
work = HERE / 'astra-validator-probe-evidence-style09'
...
(HERE / 'astra-validator-probe-summary-style09.json').write_text(json.dumps(summary, indent=2))
