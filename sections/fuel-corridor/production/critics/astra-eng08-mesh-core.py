"""Independent evaluated eng08 checks. CPU only, no render or scene save.
...
SAVED=SECTION/'production/checkpoints/eng08/Fuel_Corridor.blend'
EXPECTED='abe82d28e3ac4d4f7c6215f7f5cb870863db658be667b2167805d60f0039502e'
...
assert scene.get('stage')=='full' and scene.get('revision')=='eng08'
