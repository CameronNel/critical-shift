"""Independent support-neighborhood follow-up, unchanged frozen eng11."""
from pathlib import Path
import runpy,json,hashlib
HERE=Path(__file__).resolve().parent
c=runpy.run_path(str(HERE/'astra-eng11-mesh-core.py'))
...
report={'revision':'eng11','blend_sha256':EXPECTED,'objects':len(scene.objects),'crown_root':root_info,'crown_neighborhood':out,'saved':False,
...
(HERE/'astra-eng11-crown-evidence.json').write_text(json.dumps(report,indent=2,default=lambda v:list(v)))
