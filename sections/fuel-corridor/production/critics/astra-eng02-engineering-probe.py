"""Independent evaluated eng02 checks. CPU only, no render or scene save.
...
SAVED=SECTION/'production/checkpoints/eng02/Fuel_Corridor.blend'
EXPECTED='82fa3305998592fa793a1625cc2958c12826cfb97274868b3cf1bced30bc8bb5'
...
assert scene.get('stage')=='full' and scene.get('revision')=='eng02'
...
assert hashlib.sha256(SAVED.read_bytes()).hexdigest()==EXPECTED
(HERE/'astra-eng02-engineering-probe.json').write_text(json.dumps(report,indent=2))
