"""Independent saved eng11 motor, lamp, seam and camera checks. No scene mutations."""
...
report={'revision':'eng11','objects':len(scene.objects),'physical_meshes':len(meshes),'hashes':hashes,
...
(HERE/'astra-eng11-motor-evidence.json').write_text(json.dumps(report,indent=2))
