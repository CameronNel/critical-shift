...
SNAP=BASE.parent/'checkpoints/eng02'
...
for pid,key,length in [('F01_REFINERY','F01_connector_to_refinery',1.1),('F02_REACTOR','F02_connector_to_reactor',3.7)]:
    ...
    for ob in bpy.data.collections['01_Architecture'].objects:
        ...
        relevant=any(q in ob.name for q in ['_concrete','Port_upper_masonry','Height_step_masonry','Floor_','Ceiling_','Recessed_ceiling_panel','_vertical_flange','_vertical_web','_splice_plate','_frame_anchor','_splice_bolt'])
...
out=BASE/'astra-eng02-branch-shell-evidence.json';out.write_text(json.dumps(report,indent=2),encoding='utf-8')
