...
SAVED=SECTION/'production/checkpoints/eng12/Fuel_Corridor.blend'
EXPECTED='57ad7915bf2e939947e57dd2390305ea4e9f64b87442fa2bdd044cfacaf9929d'
...
assert scene.get('stage')=='full' and scene.get('revision')=='eng12'
