"""Independent evaluated eng05 checks. CPU only, no render or scene save.
...
SAVED=SECTION/'production/checkpoints/eng05/Fuel_Corridor.blend'
EXPECTED='f793907fcf4774d84c9c372996b641d9f28acd3142c12e98b4d22a8dbcd1ca23'
...
assert scene.get('stage')=='full' and scene.get('revision')=='eng05'
