"""Independent saved eng08 motor, lamp, seam and camera checks. No scene mutations."""
...
report={'revision':'eng08','objects':len(scene.objects),'physical_meshes':len(meshes),'hashes':hashes,
...
(HERE/'astra-eng08-motor-evidence.json').write_text(json.dumps(report,indent=2))
