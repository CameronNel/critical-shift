"""Independent evaluated eng07 checks. CPU only, no render or scene save.
...
SAVED=SECTION/'production/checkpoints/eng07/Fuel_Corridor.blend'
EXPECTED='c0ddd75920fdc6cdd2415039bab88e12a79ff522d070ea40c4a5f1b7ca539579'
...
assert scene.get('stage')=='full' and scene.get('revision')=='eng07'
