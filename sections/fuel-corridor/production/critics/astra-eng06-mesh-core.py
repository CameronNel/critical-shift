"""Independent evaluated eng06 checks. CPU only, no render or scene save.
...
SAVED=SECTION/'production/checkpoints/eng06/Fuel_Corridor.blend'
EXPECTED='caf0c11a33347cbd1655c16f06c981b7fb1aad02eb343b3231508488ccf9bb20'
...
assert scene.get('stage')=='full' and scene.get('revision')=='eng06'
