...
for i in range(8):box('Brush bristles',(-3.5+i*.025,1.15,1.060),(.009,.057,.025),'fabric',.002)
...
sphere('Discarded cleaning glove palm',(-3.55,.33,.621),(.080,.056,.018),'orange')
for i,ln in enumerate([.078,.102,.11,.095]):
    y=.29+i*.026
    tube('Glove finger',[(-3.49,y,.626),(-3.46,y,.625),(-3.46+ln*.4,y+.005,.614)],.013,'orange')
tube('Glove thumb',[(-3.56,.28,.625),(-3.52,.235,.622),(-3.49,.230,.615)],.018,'orange')
